...
class Node {
    constructor(id, x, y, ownerId, type = 'medium') {
        ...
        if (type === 'small') { this.radius = 18 + Math.random() * 10; this.influenceRadius = this.radius * 4; this.baseHp = 4; this.maxHp = 12; this.maxStock = Math.floor(this.radius * 0.5); }
        else if (type === 'large') { this.radius = 55 + Math.random() * 15; this.influenceRadius = this.radius * 3; this.baseHp = 12; this.maxHp = 35; this.maxStock = Math.floor(this.radius * 0.6); }
        else { this.radius = 32 + Math.random() * 12; this.influenceRadius = this.radius * 3.5; this.baseHp = 7; this.maxHp = 22; this.maxStock = Math.floor(this.radius * 0.5); }
        this.spawnEffect = 0;
        this.spawnTimer = 0;
